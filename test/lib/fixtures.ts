...
import Weth from '@primitivefi/contracts/artifacts/contracts/test/tokens/WETH9.sol/WETH9.json'
import Trader from '@primitivefi/contracts/artifacts/contracts/option/extensions/Trader.sol/Trader.json'
import Option from '@primitivefi/contracts/artifacts/contracts/option/primitives/Option.sol/Option.json'
import Redeem from '@primitivefi/contracts/artifacts/contracts/option/primitives/Redeem.sol/Redeem.json'
import Registry from '@primitivefi/contracts/artifacts/contracts/option/applications/Registry.sol/Registry.json'
import OptionFactory from '@primitivefi/contracts/artifacts/contracts/option/applications/factories/OptionFactory.sol/OptionFactory.json'
import RedeemFactory from '@primitivefi/contracts/artifacts/contracts/option/applications/factories/RedeemFactory.sol/RedeemFactory.json'
import OptionTemplateLib from '@primitivefi/contracts/artifacts/contracts/option/libraries/OptionTemplateLib.sol/OptionTemplateLib.json'
import RedeemTemplateLib from '@primitivefi/contracts/artifacts/contracts/option/libraries/RedeemTemplateLib.sol/RedeemTemplateLib.json'
