...
const ERR_CODES = {
  ...
  ERR_BAL_STRIKE: 'PrimitiveV1: ERR_BAL_TOKENS',
  ERR_BAL_REDEEM: 'PrimitiveV1: ERR_BAL_TOKENS',
  ERR_BAL_TOKENS: 'PrimitiveV1: ERR_BAL_TOKENS',
  ERR_BAL_OPTIONS: 'PrimitiveV1: ERR_BAL_TOKENS',
  ERR_OPTION_TYPE: 'ERR_OPTION_TYPE',
  ERR_PAUSED: 'Pausable: paused',
  ERR_OWNABLE: 'Ownable: caller is not the owner',
  ...
  ERC20_TRANSFER_AMOUNT: 'ERC20: transfer amount exceeds balance',
  FAIL: 'Route: EXECUTION_FAIL',
}
...
const CONTRACT_NAMES = {
  ...
  UNISWAP_TRADER: 'contracts/option/extensions/UniswapConnector03.sol:UniswapConnector03',
}
